...
@riverpod
FutureOr<List<String>> userAllergenIds(UserAllergenIdsRef ref) {
  return ref.watch(allergenRepositoryProvider).getUserAllergies();
}
...
FutureOr<List<Allergen>> userAllergies(UserAllergiesRef ref) async {
  ...
  final userAllergenIds = await ref.watch(userAllergenIdsProvider.future);
